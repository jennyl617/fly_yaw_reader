function [ t, disp ] = get_disp_from_raw_input( raw_data, time, zero_volt_mark, zero_volt_noise_2std )
...
endfunction [ t, vel ] = get_velocity_from_raw_input( raw_data, time, zero_volt_mark, zero_volt_noise_2std )
